...
class StatisticProtocol
{
    ...
    public static function encode($module, $interface, $cost_time, $success, $code = 0, $msg = '')
    {
        ...
        // 打包
        return pack('CCfCNnN', $module_name_length, $interface_name_length, $cost_time, $success ? 1 : 0, $code,
            strlen($msg), time()) . $module . $interface . $msg;
    }
    ...
    public static function decode($bin_data)
    {
        ...
        $interface = substr($bin_data, self::PACKAGE_FIXED_LENGTH + $data['module_name_len'],
